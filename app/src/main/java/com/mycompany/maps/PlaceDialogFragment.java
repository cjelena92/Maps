...
public class PlaceDialogFragment extends DialogFragment{
    ...
    TextView tvPhotosCount = null;
    TextView tvVicinity = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tvPhotosCount = (TextView) v.findViewById(R.id.tv_photos_count);

        // Getting reference to TextView to display place vicinity
        tvVicinity = (TextView) v.findViewById(R.id.tv_vicinity);

        if(place!=null){

            // Setting the title for the Dialog Fragment
            getDialog().setTitle(place.placeName);

            // Array of references of the photos
            Photo[] photos = place.photos;

            // Setting Photos count
            tvPhotosCount.setText("Photos available : " + photos.length);

            // Setting the vicinity of the place
            tvVicinity.setText(place.vicinity);
            ...
            String key = "key=AIzaSyBUupTnpViHtsWK7Xaiwts3ksZ5ElD69nU";
            ...
            for(int i=0;i<photos.length;i++){
                ...
                String photoReference = "photoreference="+photos[i].photoReference;
